                ...
                storage.all(keyPath, {
                    ...
                    Gnd.Util.asyncForEach(localSeq, function (item, done) {
                        ...
                        Gnd.Util.asyncForEach(newItems, function (item, done) {
                            storage.insertBefore(keyPath, item.refKeyPath, item.keyPath, {
                                insync: true
                            }, function (err) {
...
_.last(keyPath)                ];
            ...
            Queue.prototype.insertBefore = function (keyPath, id, itemKeyPath, opts, cb) {
                var _this = this;
                this.localStorage.insertBefore(keyPath, id, itemKeyPath, opts, function (err, newId) {
                    if(!err) {
                        _this.addCmd({
                            cmd: 'insertBefore',
                            keyPath: keyPath,
                    ...
                    if(this.queue.length) {
                        ...
                        switch(obj.cmd) {
                            case 'create': {
                                ...
                                (function (cid, args) {
                                    console.log(_this.currentTransfer);
