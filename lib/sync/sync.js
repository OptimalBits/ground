    ...
    (function (Sync) {
        ...
        var Manager = (function (_super) {
            ...
            function Manager(socket) {
                ...
                socket.on('push:', function (keyPath, itemKeyPath) {
                    var key = keyPathToKey(keyPath);
                    notifyObservers(_this.docs[key], 'push:', _.initial(itemKeyPath), _.last(itemKeyPath));
                });
                socket.on('unshift:', function (keyPath, itemKeyPath) {
                    var key = keyPathToKey(keyPath);
                    notifyObservers(_this.docs[key], 'unshift:', _.initial(itemKeyPath), _.last(itemKeyPath));
                });
            }
